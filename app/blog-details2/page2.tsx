							...
							<div className="row">
								<div className="col-lg-8 mx-lg-auto mb-8">
									<div className="text-center">
										...
										<h3 className="ds-3 mt-3 mb-4 text-dark">2Nvidia’s Pivotal Plans to Transform the U.S. AI Infrastructure</h3>
										<p className="text-300 fs-5 mb-0">
											2Nvidia officially announced groundbreaking plans to manufacture its AI supercomputers in the United States for the first time on April 14, 2025, marking a significant shift in its product strategy. 
										</p>
									</div>
								</div>
								...
								<div className="col-lg-10 mx-lg-auto mt-8">
									<div className="row">
										<div className="col-lg-9">
											<h5 className="mt-6">2AI Supercomputer</h5>
