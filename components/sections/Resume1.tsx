...
// 							I’m a computer science student passionate about solving real-world problems through
// 								<br />
// 								technology, entrepreneurship, and impactful innovation.
// 							</span>
// 						</div>
...
// 											<div>
// 												<p className="fw-extra-bold text-linear-1 mb-2">2022 - 2026 (expected)</p>
// 												<h5>B.A. in Computer Science, Minor in Entrepreneurship</h5>
...
// 										<div className="d-flex align-items-end">
// 											<div>
// 												<p className="fw-extra-bold text-linear-1 mb-2">Summer 2024</p>
...
// 												<h5>Frontend & Backend Developer (Freelance + Projects)</h5>
	...
	return (
		<>
			...
			<section id="resume" className="section-resume-1 position-relative pt-150 overflow-hidden" data-background="assets/imgs/projects/projects-1/background.png">
							...
							<div className="resume-card p-lg-6 p-4 mb-lg-0 mb-6">
								...
								<div className="resume-card-body">
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												<p className="fw-extra-bold text-linear-1 mb-2">Spring 2023</p>
				...
				<div className="scroll-move-right position-relative pb-160 pt-lg-150">
					<div className="d-flex align-items-center gap-5 wow img-custom-anim-top position-absolute top-50 start-50 translate-middle">
						<h3 className="stroke fs-150 text-uppercase text-white">Code . Cloud . Creativity</h3>
					</div>
				</div>
			</section>
