...
// 													<h1 className="fs-6 fw-medium">Hey, I’m Betty</h1>
// 												</div>
// 											</div>
// 											&lt;/span&gt;
// 										</div>
// 										<h1 className="fs-50 my-3">Senior <span className="text-linear-4">{'{'}c++{'}'}</span>Web &amp; App developer<span className="flicker">_</span></h1>
							...
							<div className="row align-items-end py-60">
								...
								<div className="col-lg-6 mx-lg-auto col-md-12">
									<div className="p-lg-0 p-md-8 p-3">
										...
										<h1 className="fs-50 my-3">Computer Science + Entrepreneurship <span className="text-linear-4">{'{'}dev{'}'}</span> student<span className="flicker">_</span></h1>
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">With experience in</span> <span className="text-secondary-2">Java</span>, <span className="text-secondary-2">TypeScript</span>, <span className="text-secondary-2">Angular</span>, <span className="text-secondary-2">NestJS</span>, and <span className="text-secondary-2">Salesforce development</span><span className="text-dark">, I build scalable tools, enhance digital platforms, and bridge business with technology.</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
												<Marquee className="carouselTicker carouselTicker-left position-relative z-1 mt-lg-0 mt-8">
